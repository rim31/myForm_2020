...
export default function Answer(props: { questions: any }) {
  ...
  React.useEffect(() => {
    ...
    console.log("Answer components :unstated.questions ", unstated.questions)
  ...
  React.useEffect(() => {
    ...
    // setQuestions(JSON.parse(props.questions))
  }, [props.questions])
